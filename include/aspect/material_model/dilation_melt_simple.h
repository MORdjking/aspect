...
#ifndef _aspect_material_model_dilation_melt_simple_h
#define _aspect_material_model_dilation_melt_simple_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class DilationMeltSimple : public MaterialModel::MeltInterface<dim>, public ::aspect::SimulatorAccess<dim>, public MaterialModel::MeltFractionModel<dim>
    {
      public:
        /**
        ...
        /**
         * Update the model and dilation function at the beginning
         * of each timestep.
         */
